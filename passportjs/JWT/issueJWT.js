...
const jwtSignaturesBase64 = base64url.toBase64(signatureInBase64UrlFormat)

const PUB_KEY = fs.readFileSync(__dirname + '/pub_key.pem', 'utf-8')
const signatureIsValid = verifyFunction.verify(PUB_KEY, jwtSignaturesBase64, 'base64')
